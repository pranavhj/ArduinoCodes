...
{digitalWrite(motor_4_cw,LOW);
 ...
 digitalWrite(motor_4_pwm,0);}
            ...
            float v=(((abs_rx)^2)+((abs_ry)^2))^(1/2);
            
            float alpha=atan(ry/rx);
            alpha=alpha*180/3.142;
            ...
            if(rx<-50)
           { rx_neg(abs_rx);//Serial.println(abs_rx);
           }
...
int rx_pos(int pwm_val)
{
  {digitalWrite(motor_1_cw,LOW);                                  //m1 sidha
 digitalWrite(motor_1_acw,HIGH);
 digitalWrite(motor_1_pwm,255);}

{digitalWrite(motor_2_acw,LOW);
 digitalWrite(motor_2_cw,HIGH);                                  //m2 ulta
 digitalWrite(motor_2_pwm,255/1.5);}


 {digitalWrite(motor_3_acw,LOW);
 digitalWrite(motor_3_cw,HIGH);                                //m3 ulta
 digitalWrite(motor_3_pwm,255);}



{digitalWrite(motor_4_cw,LOW);
 digitalWrite(motor_4_acw,HIGH);                               //m4 idha
 digitalWrite(motor_4_pwm,255/2.5);}
...
int rx_neg(int pwm_val)
 
{
  {digitalWrite(motor_1_acw,LOW);                                  //m1 ulta
 digitalWrite(motor_1_cw,HIGH);
 digitalWrite(motor_1_pwm,255);}

{digitalWrite(motor_2_cw,LOW);
 digitalWrite(motor_2_acw,HIGH);                                  //m2 sidha
 digitalWrite(motor_2_pwm,255/1.5);}


 {digitalWrite(motor_3_cw,LOW);
 digitalWrite(motor_3_acw,HIGH);                                //m3 sidha
 digitalWrite(motor_3_pwm,255);}



{digitalWrite(motor_4_acw,LOW);
 digitalWrite(motor_4_cw,HIGH);                               //m4 ulta
 digitalWrite(motor_4_pwm,255/1.5);}

}


int lx_pos(int pwm_val)
{
  {digitalWrite(motor_1_cw,LOW);                                   //all motor sidha
 digitalWrite(motor_1_acw,HIGH);
 digitalWrite(motor_1_pwm,pwm_val/5);}

{digitalWrite(motor_2_cw,LOW);
 digitalWrite(motor_2_acw,HIGH);
 digitalWrite(motor_2_pwm,pwm_val/5);}


 {digitalWrite(motor_3_cw,LOW);
 digitalWrite(motor_3_acw,HIGH);
 digitalWrite(motor_3_pwm,pwm_val/5);}



{digitalWrite(motor_4_cw,LOW);
 digitalWrite(motor_4_acw,HIGH);
 digitalWrite(motor_4_pwm,pwm_val/5);}
 delay(25);

}


int lx_neg(int pwm_val)
{{digitalWrite(motor_1_acw,LOW);                                   //all motor ulta
 digitalWrite(motor_1_cw,HIGH);
 digitalWrite(motor_1_pwm,pwm_val/5);}
