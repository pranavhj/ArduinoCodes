...
float kp_g=3, ki_g=0.00, kd_g=0;
float target_g=35.6;



float kp_g_r=20, ki_g_r=1, kd_g_r=0;
//float target_g=35.6;
...
analogWrite(motor_2_pwm,230-q);//Serial.println(pwmval_2);
...
/*
else if(abs(yaw-target_g)>10)
{ //Serial.println("3");
  int r=pid_func_gyro_rotation(target_g);
  //Serial.print(yaw);Serial.print("       ");Serial.println(r);
if(r<0)
{digitalWrite(motor_1_fw,1);
digitalWrite(motor_1_bw,0);
...
return(constrain((pidterm),-25,25));
